...
#         pyrosim.Send_Sensor_Neuron(name=3, linkName="LeftKnee")
#         pyrosim.Send_Sensor_Neuron(name=4, linkName="RightKnee")
...
#         pyrosim.Send_Motor_Neuron(name=9, jointName="LeftLeg_LeftKnee")
#         pyrosim.Send_Motor_Neuron(name=10, jointName="RightLeg_RightKnee")
#         pyrosim.Send_Motor_Neuron(name=11, jointName="LeftKnee_LeftFoot")
#         pyrosim.Send_Motor_Neuron(name=12, jointName="RightKnee_RightFoot")

#         # === SYNAPSES (simple mapping: sensor to corresponding motor) ===
#         pyrosim.Send_Synapse(sourceNeuronName=1, targetNeuronName=7, weight=-1.0)
#         pyrosim.Send_Synapse(sourceNeuronName=2, targetNeuronName=8, weight=-1.0)

#         pyrosim.Send_Synapse(sourceNeuronName=3, targetNeuronName=9, weight=-1.0)
#         pyrosim.Send_Synapse(sourceNeuronName=4, targetNeuronName=10, weight=-1.0)

#         pyrosim.Send_Synapse(sourceNeuronName=5, targetNeuronName=11, weight=-1.0)
#         pyrosim.Send_Synapse(sourceNeuronName=6, targetNeuronName=12, weight=-1.0)

#         pyrosim.Send_Synapse(sourceNeuronName=0, targetNeuronName=9, weight=-1.0)  # Torso to LeftLeg
#         pyrosim.Send_Synapse(sourceNeuronName=0, targetNeuronName=10, weight=-1.0)  # Torso to RightLeg
